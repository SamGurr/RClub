...
-   Objective: edit the time and preparedness to receive the output `blame it on the kids and stay home tomorrow`

```{=html}
<!-- -->
```
-   Use an `if` and `'else'` conditional statement with operators to solve!

-   a chunk is started below, fill it and try!
...
if (day != 'Sunday' & ready == 'no') { # the pseudosunday scaries 
  ...
  print('Palms sweaty, eyes twitching - become awkwardly quiet and stiff. You make your wide-eyed goodbyes to your friends as you inch closer to the exit. You will finish the task if your life depends on it.')
